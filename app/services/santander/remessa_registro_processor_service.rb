...
module Santander
  class RemessaRegistroProcessorService
    ...
    def parse
      ...
      Rails.logger.info "Numero de inscricao do beneficiario: #{data['numero_de_inscricao_do_beneficiario']}"
      Rails.logger.info "Nome do pagador: #{data['nome_do_pagador']}"

      check_and_create_customer(data["numero_de_inscricao_do_beneficiario"], data["nome_do_pagador"])
