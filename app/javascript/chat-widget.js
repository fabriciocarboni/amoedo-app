...
(function () {
    ...
    .n8n-chat-widget .chat-typing-indicator {
    display: flex;
    align-items: center;
    height: 24px;
    margin: 8px 0;
    ...
    margin-right: 6px;
    opacity: 0.5;
    animation: chat-dot-bounce 1s infinite alternate;
    }

    .n8n-chat-widget .chat-dot:nth-child(2) {
    animation-delay: 0.2s;
    }
    .n8n-chat-widget .chat-dot:nth-child(3) {
    ...
    const newConversationHTML = `
        ...
        <div class="new-conversation">
            ...
            <form class="client-form" style="margin-bottom:16px;">
                <div style="margin-bottom:12px;display:flex;gap:10px;">
                    <label style="display:flex;align-items:center;cursor:pointer;">
                        <input type="radio" name="bank" value="Santander" checked 
                ...
                <input type="text" class="client-cpf-cnpj" placeholder="CPF ou CNPJ" autocomplete="off"
                    style="margin-bottom:10px;width:100%;padding:10px;border-radius:6px;border:1px solid #ccc;font-size:15px;" />
            </form>
    ...
    const clientForm = chatContainer.querySelector('.client-form');
    const clientCpfCnpjInput = chatContainer.querySelector('.client-cpf-cnpj');
    const bankRadios = chatContainer.querySelectorAll('input[name="bank"]');
    ...
    function validateFormFields() {
        const cpfCnpjOk = clientCpfCnpjInput.value.trim().length > 0;
        newChatBtn.disabled = !cpfCnpjOk;
    }

    clientCpfCnpjInput.addEventListener('input', validateFormFields);
    clientForm.addEventListener('submit', (e) => e.preventDefault());

    let clientCpfCnpj = '';
    let selectedBank = 'Santander'; // Default value

    // Update selected bank when radio buttons change
    ...
    async function startNewConversation() {
        clientCpfCnpj = clientCpfCnpjInput.value.trim();
    ...
    async function sendMessage(message) {
        ...
        try {
            ...
            // Hide the typing indicator before showing the bot's answer
            hideTypingIndicator();
